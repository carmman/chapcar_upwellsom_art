...
def initialisation(case_label_base,tseed=0):
    ...
    return case_name_base,varnames,list_of_plot_colors
#
#######################################################################
...
def plot_obs(sst_obs,lon,lat,varnames=None,title="",
             lolast=4,figsize=(12,7),cmap='jet',
             wspace=0.04, hspace=0.12, top=0.925, bottom=0.035, left=0.035, right=0.97,
             TRENDLESS=False,WITHANO=True,climato=None,UISST=False,
             NORMMAX=False,CENTRED=False,Show_ObsSTD=False) :
    #
    Nobs, Lobs, Cobs = np.shape(sst_obs)
